...
public class NativeDataManager {
    ...
    public boolean getSendSMSHint() {
        return mPreference.getBoolean(Constant.SEND_PERMISSION_HINT, true);
    }

    public void setSendSMSHint(boolean hint) {
        mPreference.edit().putBoolean(Constant.SEND_PERMISSION_HINT, hint).apply();
    }
    ...
    public boolean getWeChatRelay() {
        return mPreference.getBoolean(Constant.KEY_RELAY_WECHAT, false);
    }

    public String getWeChatName() {
        return mPreference.getString(Constant.WECHAT_NAME, "");
    }

    public void setWeChatName(String name) {
        mPreference.edit().putString(Constant.WECHAT_NAME, name).apply();
    }

    public String getWeChatContent() {
        return mPreference.getString(Constant.WECHAT_CONTENT, "");
    }

    public void setWeChatContent(String name) {
        mPreference.edit().putString(Constant.WECHAT_CONTENT, name).apply();
    }

    public void setWeChatRelay(Boolean b) {
        mPreference.edit().putBoolean(Constant.KEY_RELAY_WECHAT, b).apply();
    }
